...
const Article = () => {
  ...
  // const loadChList = async () => {
  //   const res = await http.get('/channels')
  //   setChList(res.data.channels)
  // }
  // useEffect(() => {
  //   loadChList()
  // }, [])
  ...
  return (
    <div>
        ...
        <Form
          ...
          <Form.Item label="频道" name="channel_id">
            ...
            >
              ...
              {/* {chList.map(item => <Option key={item.id} value={item.id}>{item.name}</Option>)} */}
            </Select>
          </Form.Item>
      ...
      {/* 文章列表区域 */}
      <Card title={`共查詢到 ${articleData.count} 個結果：`}>
        <Table
          rowKey="id"
          columns={columns}
